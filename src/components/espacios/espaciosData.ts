...
export const TIPOLOGIAS: readonly Tipologia[] = [
  {
    ...
    codigo: "TA-NJ-PB",
    letra: "TA-NJ",
    nombre: "Tipología A — Nivel Jardín",
    ...
    plantas: [
      {
        ...
        alt: "Planta baja ilustrada de Tipología A Nivel Jardín con jardín privado, terraza y estancia",
      },
      {
        id: "pa",
        ...
        alt: "Planta alta ilustrada de Tipología A Nivel Jardín con recámaras y vestidores",
      },
    ],
    renders: [
      {
        ...
        alt: "Render de sala estancia en Tipología A Nivel Jardín con vista y ventanales al jardín",
    ...
    plantas: [
      {
        ...
        alt: "Planta ilustrada Nivel 5 de Penthouse Tipología A con amplia estancia y terraza techada",
      },
      {
        id: "pa",
        ...
        alt: "Planta ilustrada Nivel 6 de Penthouse Tipología A con patio privado y terraza superior",
      },
    ],
    renders: [
      {
...
export const ESTANCIAS: readonly Estancia[] = [
  ...
  },
  {
    ...
    desc: "Exclusivo para unidades de Nivel Jardín (46.39 m²) y Penthouses (70.90 m² de patio sin techar).",
    x: 76,
    y: 62,
  },
];
...
export const NIVELES: readonly Nivel[] = [
  ...
  { codigo: "N0 / PB", uso: "Tipología A Nivel Jardín (2) y Amenidades", y: 61.7 },
