...
export const LAMINAS: Lamina[] = [
  ...
  },
  {
    ...
    crop: {
      ratio: "aspect-[5/4]",
      imgClass: "object-cover object-center scale-[1.06] origin-center",
      nota: "scale-1.06 eats ~3% per edge: kills the light artefact in the bottom-right corner and the hairlines along the borders.",
    },
    miniatura: { fondo: "bg-cream-dark", imgClass: "object-cover object-center scale-[1.06]" },
    visor: { plate: "dark" },
  },
  {
    id: "06",
  ...
  },
  {
    ...
    crop: {
      ratio: "aspect-[80/29]",
      imgClass: "object-cover object-top",
      nota: "HARD RULE. The clean photo ends at 77.5% of the height; below it a flat grey band (#252525) and a green one (#122e1e). With object-top the visible fraction is 2.0725/R, so any frame narrower than 2.71:1 brings the dirt back. 80/29 = 2.759 shows 75.1%.",
    },
    miniatura: { fondo: "bg-cream-dark", imgClass: "object-cover object-top" },
    visor: { plate: "dark" },
  },
  {
    id: "08",
    ...
    crop: {
      ratio: "aspect-[5/4]",
      imgClass: "object-cover object-center scale-[1.04]",
      nota: "1–3 px dark hairlines on the left and top edges: 5/4 trims ~4% per side and scale-1.04 finishes the job.",
    },
    miniatura: { fondo: "bg-cream-dark", imgClass: "object-cover object-center scale-[1.04]" },
    visor: { plate: "dark" },
  },
  {
    id: "09",
    ...
    crop: {
      ratio: "aspect-[3/2]",
      imgClass: "object-cover object-top",
      nota: "Dark block in the bottom-right corner from ~92% of the height. 3/2 + object-top shows the top 83.3%. Lowest-resolution file of the set: never wider than ~900 CSS px.",
    },
    miniatura: { fondo: "bg-cream-dark", imgClass: "object-cover object-top" },
    visor: { plate: "dark" },
  },
  {
    ...
    crop: {
      ratio: "aspect-[586/840]",
      imgClass: "object-cover object-center",
      nota: "Clean file: shown in its native ratio, no sanitising crop. Max ~420 CSS px wide.",
    },
